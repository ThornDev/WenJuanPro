...
> 版本: v1.0 · 日期: 2026-04-17 · 作者: 范蠡（产品经理） · 模式: draft-first
>
> 输入: `docs/project-brief.md` v0.2（2026-04-17）+ 用户决策确认（Q1/Q2/Q3/Q4 + 7 项 Phase 3 决策，2026-04-17）
...
> _本节占位。待用户确认 PRD 初稿后，由 PM 执行 `*execute-checklist workflow-pm-validation` 填充。_
