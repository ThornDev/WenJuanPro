...
object StagedMultiChoiceTags {
    const val ROOT = "staged_multi_choice_root"
    const val STEM_BLOCK = "staged_multi_choice_stem_block"
    const val OPTIONS_BLOCK = "staged_multi_choice_options_block"
    const val PHASE_LABEL = "staged_multi_choice_phase_label"
    const val SUBMIT_BUTTON = "staged_multi_choice_submit_button"
}

@Composable
fun StagedMultiChoiceScaffold(
    state: QuestionUiState.MultiChoiceStaged,
    ...
    Column(
        ...
        Text(
            ...
            modifier =
                Modifier
                    ...
                    .testTag(StagedMultiChoiceTags.PHASE_LABEL),
        )
        ...
        AnimatedContent(
            ...
            label = "staged_multi_stage_content",
                ...
                QuestionUiState.Stage.STEM ->
                    Box(
                        modifier =
                            Modifier
                                .fillMaxSize()
                                .testTag(StagedMultiChoiceTags.STEM_BLOCK)
                                .pointerInput(Unit) {
                ...
                QuestionUiState.Stage.OPTIONS ->
                    Column(
                        modifier =
                            Modifier
                                .fillMaxSize()
                                .testTag(StagedMultiChoiceTags.OPTIONS_BLOCK),
