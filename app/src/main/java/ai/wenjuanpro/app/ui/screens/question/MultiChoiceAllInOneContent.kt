...
object MultiChoiceAllInOneTags {
    const val ROOT = "multi_choice_all_in_one_root"
    const val PROGRESS_LABEL = "multi_choice_progress_label"
    const val SUBMIT_BUTTON = "multi_choice_submit_button"
}

@Composable
fun MultiChoiceAllInOneContent(
    state: QuestionUiState.MultiChoiceAllInOne,
        ...
        Text(
            ...
            modifier =
                Modifier
                    ...
                    .testTag(MultiChoiceAllInOneTags.PROGRESS_LABEL),
        )
